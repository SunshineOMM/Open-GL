...
int main() {
	...
	srand(time(NULL));//сброс опорного значения функции rand
	...
	//==========================================================================================================================================================
		...
		//==========================================================================================================================================================
		glUseProgram(renderProgram.id);//делаем текущую шейдерную программу текущей
		glUniform1f(renderPointSizeLocation, POINT_SIZE);// задаём передаваемое всем шейдерам переменную типа uniform
